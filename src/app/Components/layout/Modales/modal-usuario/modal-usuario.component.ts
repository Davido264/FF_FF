...
guardarEditar_Usuario(){
  ...
  if(this.datosUsuario == null){
     ...
     next:(data) =>{
       ...
       this._utilidadServicio.mostrarAlerta("No se pudo regitrar el usuario","Error")
    ...
    this._usuarioServicio.editar(_usuario).subscribe({
      next:(data) =>{
        if(data.status){
         this._utilidadServicio.mostrarAlerta("El usuario fue actualizado correctamente","Exito");
         this.modalActual.close("true")
        }else 
        this._utilidadServicio.mostrarAlerta("No se pudo actualizar al usuario","Error")
